...
// the page's to edit until Ready to Pay. One fact per row: source, warehouse,
// then the delivery switch beside what that choice needs, so the collector or
// the tracking number can't read as the row above's. Same switch and carrier
// chips as the checkpoint (they share the CSS and the tracking recipe), so a
// number pasted here is recognised exactly as it would be there.
...
export function DeliveryTab(p: Props) {
  ...
  return (
    <div className="oe-tabpad">
      <div className="oe-dl">
        <div className="oe-fields oe-fields-3 oe-dl-row">
