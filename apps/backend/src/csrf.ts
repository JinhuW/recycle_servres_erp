...
// (unauthenticated, externally-called) vendor endpoints, and the OAuth
// surfaces are exempt — CSRF is a cookie-confused-deputy attack and those
// routes are not cookie-auth'd (OAuth /token, /revoke, /register, and the
// discovery docs all use client credentials or are public metadata).
