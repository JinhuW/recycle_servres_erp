...
|---|---|---|---|---|---|
| [RS-107](./RS-107-manager-only-data-is-absent-from-every-non-manager-a.md) | in-progress | bug | P2 | Manager-only data is absent from every non-manager API response | — |
