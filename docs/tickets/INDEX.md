...
|---|---|---|---|---|---|
| [RS-043](./RS-043-vendor-price-import-records-market-values.md) | in-review | bug | P2 | Vendor price import records market values | 1.138.3 |
| [RS-042](./RS-042-new-session-sh-launches-without-bypass-mode.md) | in-review | bug | P2 | new-session.sh launches without bypass mode | — |
