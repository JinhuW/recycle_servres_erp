...
|---|---|---|---|---|---|
| [RS-079](./RS-079-paypal-pull-failures-are-reported-and-throttled.md) | in-progress | bug | P2 | PayPal pull failures are reported and throttled; the phone scan keeps concurrent edits | — |
