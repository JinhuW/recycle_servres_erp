...
Asked on 2026-09-03; the work was written that day as #248 under RS-015 /
v1.120.0 / migration 0117, but the PR sat unmerged while all three numbers were
taken by other work.  On 2026-09-13, asked to review everything not yet on
`dev`, Jinhu had the forgotten change re-cut on today's code:
...
Re-cut of #248: the code commit is cherry-picked unchanged; the migration is
renumbered 0117 → 0125 (the head on `dev` at the time), and the ticket,
version and changelog section are redone under free numbers.
